...
test-validation: clean-ops
	TEST_DIRECTORY=./validation/... SKIP_GENESIS_ALLOCS=true go run gotest.tools/gotestsum@latest --format testname -- -tags "" -run '[^TestValidation|^TestPromotion|^TestGenesisAllocs]'
