...
func init() {
	Config = make(map[string]*ConfigTy)

	Config["mainnet"] = new(ConfigTy)
	var err error
...
func decodeTOMLFileIntoConfig(filename string, config *ConfigTy) error {
