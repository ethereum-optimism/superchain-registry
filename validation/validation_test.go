...
func testUniversal(t *testing.T, chain *ChainConfig) {
	t.Run("Genesis Hash", func(t *testing.T) { testGenesisHash(t, chain.ChainID) })
	t.Run("Genesis RPC", func(t *testing.T) { testGenesisHashAgainstRPC(t, chain) })
	t.Run("Uniqueness", func(t *testing.T) { testIsGloballyUnique(t, chain) })
	t.Run("ChainID RPC", func(t *testing.T) { testChainIDFromRPC(t, chain) })
	t.Run("Optimism Config", func(t *testing.T) { testOptimismConfig(t, chain) })
}
...
func testStandardCandidate(t *testing.T, chain *ChainConfig) {
	...
	t.Run("Start Block RPC", func(t *testing.T) { testStartBlock(t, chain) })
...
func testStandard(t *testing.T, chain *ChainConfig) {
	...
	// Standard Config Roles
	t.Run("Key Handover", func(t *testing.T) { testKeyHandover(t, chain.ChainID) })
}
