...
func main() {
	rpcURL := flag.String("rpcURL", "https://eth-mainnet.g.alchemy.com/v2/6eCsAcYZmnnoS-FV6PCfqmObgK0prq-u", "RPC URL")
	network := flag.String("network", "mainnet", "Network (mainnet or sepolia)")
	...
	if *rpcURL == "" {
		fmt.Println("Error: rpcURL is required")
		flag.Usage()
		os.Exit(1)
	}
	...
	genesisPath := "https://raw.githubusercontent.com/ethereum-optimism/superchain-registry/main/superchain/configs"
	l1AddressesPath := "https://raw.githubusercontent.com/ethereum-optimism/superchain-registry/main/superchain/extra/addresses"
	...
	for _, chain := range chains {
		...
		// challengePeriod, _ := getChallengePeriod(*rpcURL, l1AddressesConfig.L2OutputOracleProxy)
...
// func getL2BlockTime(rpcURL string, l2OutputOracleProxy string) (string, error) {
// 	var l2BlockTime string
// 	var err error

// 	l2BlockTime, err = getOnChainInteger(rpcURL, l2OutputOracleProxy, "0x93991af3") // l2BlockTime()
// 	if l2BlockTime == "0" || err != nil {
// 		l2BlockTime, err = getOnChainInteger(rpcURL, l2OutputOracleProxy, "0x002134cc") // L2_BLOCK_TIME()
// 		if err != nil {
// 			return "", fmt.Errorf("there was an error fetching the l2BlockTime: %w", err)
// 		}
// 	}
// 	return l2BlockTime, nil
// }
