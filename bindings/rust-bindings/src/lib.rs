...
lazy_static::lazy_static! {
    ...
    pub static ref ADDRESSES: Addresses = _INIT.addresses.clone();

    /// Genesis system configurations exported from the registry
    pub static ref GENESIS_SYSTEM_CONFIGS: GenesisSystemConfigs = _INIT.genesis_system_configs.clone();

    /// Contract implementations exported from the registry
    pub static ref IMPLEMENTATIONS: Implementations = _INIT.implementations.clone();
